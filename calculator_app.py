...
button_negate = Button(root, text="+/-", padx=34, pady=20, command=lambda: operator_button_click("+/-"))
button_decimal = Button(root, text=".", padx=42, pady=20)
